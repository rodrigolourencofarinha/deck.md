...
For designer-mode images, use Codex image generation first. If it fails or cannot accept the required inputs, tell the human what failed and ask whether to continue with the direct OpenAI Image API fallback.
